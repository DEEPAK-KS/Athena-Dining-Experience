...
(function(a, b) {
    ...
    function q(a) {
        ...
        c.contains(a.scrollbarXRail) ||
            ...
            (f(c, z.element.rail("y")).forEach(function(a) {
                ...
                c.appendChild(a.scrollbarYRail)), !a.settings.suppressScrollX &&
    ...
    var E = {
        ...
        G = {
            ...
            wheel: function(b) {
                function c(a, c) {
                    ...
                    return (
                        (d = u(c) > u(a) ? f || g : i || j), !d || !b.settings.wheelPropagation
                    );
                }
            ...
            touch: function(b) {
                ...
                function g(a) {
                    return (!(a.pointerType && "pen" === a.pointerType && 0 === a.buttons) &&
        ...
        H = function(d, e) {
            ...
            (this.isRtl = "rtl" === a(d).direction), !0 === this.isRtl && d.classList.add(z.rtl),
