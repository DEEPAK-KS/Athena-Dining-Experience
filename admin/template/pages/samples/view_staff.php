            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" id="store_data" action="update_db.php" method="POST" onsubmit="return(validateForm());">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" list="staff_promotion" class="form-control" name="firstName" id="firstName" placeholder="Enter your first name" onblur="validateFirstName();">
                    ...
                    <input class="hover_mycolor add_staff" type="submit" value="Update Staff">
                  </form>
                </div>
              </div>
            </div>
      ...
      var fullName = $('#firstName').val();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                console.log('Response Date of Birth:', response.DateOfBirth);
                ...
                // Cuisine Preferences (as it's a multiple select)
                var cuisinePreferences = response.CuisinePreferences.split(",");
                $('#cuisine').val(cuisinePreferences);
                // Membership Type
                $('input[name="membershipRadios"][value="' + response.Type + '"]').prop('checked', true);
...
<script>
  $(document).ready(function() {
    ...
    $('#firstName').on('input', function() {
      ...
      $.ajax({
        url: 'fetch_staff_name.php', // Change the URL to your server endpoint
        type: 'POST',
        dataType: 'json',
        data: {
          inputChar: inputChar
        ...
        success: function(data) {
          ...
          $.each(data, function(index, item) {
            $('#staff_promotion').append('<option value="' + item.FirstName + ' ' + item.LastName +'">' + item.FirstName + ' ' + item.LastName + '</option>');
          });
        },
        error: function(xhr, status, error) {
          console.error(error);
