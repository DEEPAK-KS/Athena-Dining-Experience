  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" href="../Add Staff/Staff_1.php">
            <span class="menu-icon">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="auth">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="../samples/register.php"> Add Admin </a></li>
            </ul>
          </div>
        </li>
      </ul>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="membershipRadios"
                                  id="membershipRadios1" value="Cloud">
                                Cloud
                              </label>
                            </div>
                          </div>
                          <div class="col-sm-5">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="membershipRadios"
                                  id="membershipRadios2" value="Professional" checked>
                                Professional
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="tel" class="form-control" name="phone" id="phone"
                              placeholder="Enter your phone number" onblur=" validatePhone();">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="address1" id="address1"
                              placeholder="Enter your address line 1" onblur="validateAddress1();">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="state" id="state"
                              placeholder="Enter your state" onblur="validateState();">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="address2" id="address2"
                              placeholder="Enter your address line 2" onblur="validateAddress2();">
    ...
    function checkStatusAndToggleButtons() {
        ...
        if (staffInput && staffID) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: { staff_input: staffInput, staff_ID: staffID },
